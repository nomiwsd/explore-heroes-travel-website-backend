        ...
        try {
            ...
            return response()->json([
                'data' => [
                    ...
                    'number_of_people' => $contact->number_of_people,
                    'special_requirements' => $contact->special_requirements,
                    'destination_name' => $contact->destination_name,
                    'tour_id' => $contact->tour_id,
                    'tour_name' => $contact->tour ? $contact->tour->title : null,
