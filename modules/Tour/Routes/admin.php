...
Route::get('/tour/location',  'TourController@indexLocation')->name('tour.admin.location.index');
Route::get('/tour/location/edit/{id}', 'TourController@editLocation')->name('tour.admin.location.edit');
Route::post('/tour/location/store/{id}', 'TourController@storeLocation')->name('tour.admin.location.store');
Route::post('/tour/location/bulkEdit', 'TourController@bulkEditLocation')->name('tour.admin.v.bulkEdit');
