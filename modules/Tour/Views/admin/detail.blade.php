                    ...
                    <div class="col-md-2 p-0">
                        <div class="card">
                            ...
                            <div class="list-group list-group-flush">
                                ...
                                <a
                                    href="#tab_location" class="list-group-item list-group-item-action d-flex justify-content-between align-items-center @if(!$row->id) disabled @endif" data-toggle="tab"
                                >
                                    {{__('Location')}}
                                    @if(!$row->id)
